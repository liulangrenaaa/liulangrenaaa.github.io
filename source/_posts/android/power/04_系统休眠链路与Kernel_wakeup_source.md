...
这一篇只讲一个问题：**Android 灭屏之后，系统到底怎样从 Framework 走到 Kernel suspend？如果没睡下去，应该看哪一层？**
...
排查待机功耗时，先不要急着盯着 `wakeup_sources` 某一行骂。正确顺序是：
...
| 名字很像某模块但 delta 没变化 | 不要甩锅，它只是历史出现过 |
...
不要把插 USB 时抓到的数据包装成“自然待机”。插 USB 会影响：
...
如果面试官问“Android 灭屏后怎么进入 suspend”，可以这样回答：
...
如果问“wakeup_sources 里看到某个名字很大，能不能说它是根因”，可以这样回答：
